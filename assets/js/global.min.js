...
! function (a) {
    ...
    a.fn.fitVids = function (b) {
        ...
        return b && a.extend(c, b), this.each(function () {
            var b = ["iframe[src*='player.vimeo.com']", "iframe[src*='youtube.com']", "iframe[src*='google.com']", "iframe[src*='youtube-nocookie.com']", "iframe[src*='kickstarter.com'][src*='video.html']", "object", "embed"];
...
function (a, b, c) {
    function d(b, c) {
        this.element = b, this.options = a.extend({}, f, c), this.scroll_timer = null, this._defaults = f, this._name = e, this.init()
    }
    var e = "readingTime",
        f = {
            bubble: "#scrollbubble"
...
jQuery(document).ready(function () {
    function a() {
        if ("" != config.disqus_shortname) {
            ...
            ! function () {
                ...
                b.type = "text/javascript", b.async = !0, b.src = "//" + a + ".disqus.com/embed.js", (document.getElementsByTagName("head")[0] || document.getElementsByTagName("body")[0]).appendChild(b)
            }()
        } else 1 == config.google_comments && $.getScript("https://apis.google.com/js/plusone.js").done(function () {
    ...
    if ($("pre code").parent().each(function () {
        $(this).addClass("prettyprint"), b = !0
    }), b && 1 == config.highlightcode && prettyPrint(), $("#cover").hasClass("featured") ? $(".posts").waypoint(function (a) {
        "down" === a && ($(".profile").addClass("stuck").removeClass("featured"), $(".index").fadeIn(400)), "up" === a && ($(".profile").removeClass("stuck").addClass("featured"), $(".index").fadeOut(400))
    }) : $("#posttitle, .first").waypoint(function (a) {
        "down" === a && ($(".profile").addClass("stuck"), $(".index").fadeIn(400)), "up" === a && ($(".profile").removeClass("stuck"), $(".index").fadeOut(400))
    }), $(".postprofile").waypoint(function (a) {
        "down" === a && $(".profile").addClass("hide"), "up" === a && $(".profile").removeClass("hide")
    }, {
        offset: "100%"
    }), $("#cover").hasClass("featured")) {
        var c = $('img[alt="featureimage"]').attr("src");
        $("#cover .background").css("background-image", "url('" + c + "')")
    }
    if ($("#posttitle").length) {
        var d = [];
        $(".postbody h2").waypoint(function (a) {
            var b = $(this);
            "down" === a && $(".index h2").fadeOut(function () {
                d.push($(".index h2").text()), $(this).text($(b).text()).fadeIn()
            }), "up" === a && $(".index h2").fadeOut(function () {
                $(this).text(d.pop()).fadeIn()
            })
        })
    }
    jQuery(".postbody").fitVids(), ("" != config.disqus_shortname && null != config.disqus_shortname && void 0 != config.disqus_shortname || 1 == config.google_comments) && ($(".comments").show(), 1 == config.autoload_comments && (a(), $(".readmore").fadeOut(400))), $(".readmore").click(function () {
        a(), $(this).fadeOut(400)
    }), ("" != config.analytics_id || null != config.analytics_id || void 0 != config.analytics_id) && (! function (a, b, c, d, e, f, g) {
        a.GoogleAnalyticsObject = e, a[e] = a[e] || function () {
            (a[e].q = a[e].q || []).push(arguments)
        }, a[e].l = 1 * new Date, f = b.createElement(c), g = b.getElementsByTagName(c)[0], f.async = 1, f.src = d, g.parentNode.insertBefore(f, g)
    }(window, document, "script", "//www.google-analytics.com/analytics.js", "ga"), ga("create", config.analytics_id, config.analytics_domain), ga("send", "pageview")), 1 == config.readingtime && $(".postbody").readingTime()
});